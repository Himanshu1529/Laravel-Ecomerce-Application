              ...
              <form action="" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('name') }}" required="" name="name" placeholder="Enter Category Name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('meta_description') }}"  name="meta_description" placeholder="Meta Description">
                  </div>
